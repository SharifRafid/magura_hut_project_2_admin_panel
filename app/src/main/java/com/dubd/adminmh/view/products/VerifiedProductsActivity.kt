...
class VerifiedProductsActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_verified_products)
        ...
        val databaseReference = FirebaseDatabase.getInstance().getReference("verifiedOrders")
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                mainList.onItemClickListener =
                    AdapterView.OnItemClickListener { _, _, p2, _ ->
                        val intent = Intent(this@VerifiedProductsActivity,SingleProductActivity::class.java)
                        intent.putExtra("fRoot","verifiedOrders/")
